...
/// One balances snapshot for a point in time.
...
struct BalancesProvider: TimelineProvider {
    ...
    /// Publish current balances and request a refresh in about 15 minutes.
...
/// Checking & savings balances widget (no Edit Widget configuration).
