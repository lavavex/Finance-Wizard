...
/// Chart of spend by category: horizontal bars, vertical bars, or pie/donut.
struct CategorySpendChartView: View {
    ...
    /// When true, dollar labels become placeholders (see ScreenshotPrivacy).
    @Environment(\.screenshotPrivacy) private var screenshotPrivacy

    /// Category names in input order — used as the chart color scale domain.
    ...
    /// Format dollars, respecting screenshot privacy.
    ...
    /// Inner hole size as a fraction of the pie radius (donut).
            ...
            ForEach(slices) { item in
                ...
                if share >= (ultraCompact ? 0.05 : 0.04) {
                    ...
                    .mask {
                        ...
                        // White = visible in mask; clear = hidden
